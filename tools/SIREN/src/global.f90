...
MODULE global
   ...
   CHARACTER(LEN=lc)                       , PARAMETER :: cp_url="$URL: svn+ssh://gm@forge.ipsl.jussieu.fr/ipsl/forge/projets/nemo/svn/utils/tools/SIREN/src/global.f90 $"    !< svn url
   CHARACTER(LEN=lc)                       , PARAMETER :: cp_version = "$Revision: 12080 $"
   CHARACTER(LEN=lc)                       , PARAMETER :: cp_author = "$Author: jpaul $"
   CHARACTER(LEN=lc)                       , PARAMETER :: cp_date = "$Date: 2019-12-06 10:30:14 +0100 (Fri, 06 Dec 2019) $"
