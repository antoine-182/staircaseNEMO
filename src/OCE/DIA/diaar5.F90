...
#  include "domzgr_substitute.h90"
   ...
   !! $Id: diaar5.F90 12489 2020-02-28 15:55:11Z davestorkey $
...
CONTAINS
   ...
   SUBROUTINE dia_ar5( kt, Kmm )
      ...
      REAL(wp), ALLOCATABLE, DIMENSION(:,:,:)   :: z3d, zrhd , zrhop, ztpot, zgdept   ! 3D workspace (zgdept: needed to use the substitute)
...
!!gm
         ...
         CALL eos( ts(:,:,:,:,Kmm), zrhd, zrhop, zgdept )                 ! now in situ and potential density
         zrhop(:,:,jpk) = 0._wp
